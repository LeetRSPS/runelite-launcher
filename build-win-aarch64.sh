...
cp native/build-aarch64/src/Release/Celestial.exe build/win-aarch64/
cp build/libs/Celestial.jar build/win-aarch64/
...
echo Celestial.exe aarch64 sha256sum
sha256sum build/win-aarch64/Celestial.exe

dumpbin //HEADERS build/win-aarch64/Celestial.exe
