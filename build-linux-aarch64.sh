...
sha256sum build/libs/Celestial.jar
...
chmod 644 build/libs/Celestial.jar

cp native/build-aarch64/src/Celestial build/linux-aarch64/
cp build/libs/Celestial.jar build/linux-aarch64/
...
# Symlink AppRun -> Celestial
ln -s Celestial AppRun

# Ensure Celestial is executable to all users
chmod 755 Celestial
popd
