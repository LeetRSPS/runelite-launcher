...
AppSupportURL=https://celestial.com
...
OutputBaseFilename=CelestialSetup32

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${project.projectDir}\build\win-x86\Celestial.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-x86\Celestial.jar"; DestDir: "{app}"
