...
cp native/build-x86/src/Release/Celestial.exe build/win-x86/
cp build/libs/Celestial.jar build/win-x86/
...
echo Celestial.exe 32bit sha256sum
sha256sum build/win-x86/Celestial.exe

dumpbin //HEADERS build/win-x86/Celestial.exe
