...
- Replace all `Celestial` (case sensitive) with your server name.
- Replace all `celestial` (case sensitive) with your lowercase server name.
- Replace `celestialrsps.teamgames.io/vote`/`celestialrsps.teamgames.io/vote` with your domain name.
