...
cp native/build-x64/src/Release/Celestial.exe build/win-x64/
cp build/libs/Celestial.jar build/win-x64/
...
echo Celestial.exe 64bit sha256sum
sha256sum build/win-x64/Celestial.exe

dumpbin //HEADERS build/win-x64/Celestial.exe
